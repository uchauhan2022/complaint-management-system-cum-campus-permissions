  ...
  Datepicker.prototype = {
    ...
    fill: function() {
      ...
      while (prevMonth.valueOf() < nextMonth) {
        ...
        html.push('<td class="' + clsName.join(' ') + '"' + (tooltip ? ' title="' + tooltip + '"' : '') + (this.o.dateCells ? ' data-date="' + prevMonth.getTime().toString() + '"' : '') + '><div class="day">' + prevMonth.getUTCDate() + '</div></td>');
        tooltip = null;
    ...
    click: function(e) {
      ...
      if (!target.hasClass('disabled')) {
        // Clicked on a day
        if (target.hasClass('day')||target.parent().hasClass('day')) {
